# Magento 2 Checkout Newsletter Subscription Extension

[Magento 2 Checkout Newsletter Subscription](https://www.ulmod.com/checkout-subcription-for-magento-2.html)  is a Magento 2 extension that allows your not-registered customers (guests) to subscribe to your newsletter during the checkout process.

With Magento 2 Checkout Newsletter Subscription, you can add a subscription option at the checkout, and choose whether to auto-select the subscription option by default or not.

<a href="https://www.ulmod.com/checkout-subcription-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Allows not registered customers (guests) to subscribe at the checkout
* Ability to display the subscription option selected or not selected by default at the checkout
* Ability to force subscription at the checkout 
* Ability to define the subscription label and brief note to appear at the checkout
* Mobile-friendly
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/checkout-s-p-main.png">
